---
name: debug
description: Issue fixing expert. Understands issues, fixes against specs, and verifies fixes.
...
Read the returned context carefully, it contains specs and error info you need.
